    ...
    <div class="wrapper">
        ...
        <header class="navbar">
            ...
            <div class="upside flex ">
                ...
                <img class='d-inline' src="img/google-logo.svg" alt="">
                <h4 class='d-inline'>Privacy e Termini</h4>

            </div>

            <div class="downside flex">
                <ul>
                   <li>
                       <a href="">
                       Introduzione
        ...
        <main>
            <div class="row">
                ...
                <?php
                    foreach ($db as $question_and_answer => $text) {

            
                        echo '<h2>'.$text['question'].'</h2>';

                        echo '<p>'.$text['answer'].'</p>';
